...
interface UserItemsServiceProxy {
	 ...
	 * @returns ServiceProxyResponse
	 */ 
	sysAwardUserItem(defId: string, quantity: number, includeDef: boolean, optionsJson: Object): ServiceProxyResponse;
	 ...
	 * @returns ServiceProxyResponse
	 */ 
	sysAwardUserItemToUser(profileId: string, defId: string, quantity: number, includeDef: boolean, optionsJson: Object): ServiceProxyResponse;
	 ...
	 * @param  {Integer} version The version of the bundle user item being sold. Accepts -1 if any version.
	 * @param  {Integer} quantity The quantity of the bundle user item to open.
	 ...
	 * @returns ServiceProxyResponse
	 */ 
	getItemsOnPromotion(shopId: string, includeDef: boolean, includePromotionDetails: boolean): ServiceProxyResponse;
}