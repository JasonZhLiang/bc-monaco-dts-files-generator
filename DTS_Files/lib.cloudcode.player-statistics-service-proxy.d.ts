...
interface PlayerStatisticsServiceProxy {
	 ...
	 * 
	 * @param  {Array<any>} statistics A collection containing the statistics to read.
	 * @returns ServiceProxyResponse
	 */ 
	 ...
	 * 
	 * @param  {number} xp_points The amount to increase the user's experience by.
	 * @returns ServiceProxyResponse
	 */ 
	 ...
	 * 
	 * @param  {Object} statistics The data to be passed to method.
	 * @returns ServiceProxyResponse
	 */ 
	 ...
	 * 
	 * @param  {Object} statistics The stats data to be passed to the method.
	 * @returns ServiceProxyResponse
	 */ 
	 ...
	 * 
	 * @param  {number} xp_points The amount to set the user's experience to.
	 * @returns ServiceProxyResponse
	 */ 
