...
interface ItemCatalogServiceProxy {
	 ...
	 * @param  {NativeObject} itemDefData The data defining the ITEM type catalog item.
	 * @returns ServiceProxyResponse
	 */ 
	 ...
	 * @param  {NativeObject} itemDefData The data to update on the ITEM type catalog item.
	 * @returns ServiceProxyResponse
	 */ 
