...
interface LobbyServiceProxy {
	 ...
	 * @param  {NativeObject} criteriaJson JSON object describing the filter criteria. Supported sub-values include 'rating' (required) and 'includeUnavailable' (optional).
	 * @returns ServiceProxyResponse
	 */ 
	getLobbyInstances(lobbyType: string, criteriaJson: Object): ServiceProxyResponse;
