...
interface ScriptServiceProxy {
	 ...
	 * @param  {Object} scriptData Data to be sent to the script in JSON format.
	 * @param  {number} minutesFromNow Number of minutes from now to run the script.
	 ...
	 * @param  {string} scriptName The name of the script to be run.
	 * @param  {Object} scriptData Data to be sent to the script in JSON format.
	 * @param  {number} startDateUTC The start date. (date in millis.)
	 * @returns ServiceProxyResponse
	 */ 
	 ...
	 * 
	 * @param  {number} startDateUTC The start time in milliseconds for which cloud scripts are scheduled to run on or prior to.
	 * @returns ServiceProxyResponse
	 */ 
