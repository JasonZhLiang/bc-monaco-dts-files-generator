...
interface ProductManagementServiceProxy {
	 ...
	 * 
	 * @param  {Object} productJson The product details.
	 * @returns ServiceProxyResponse
	 */ 
	 ...
	 * @param  {number} version The product configuration version.
	 * @param  {Object} productJson The product details to update. Note: If itemId is included in the productJson, it is ignored. The itemId provided as a direct parameter takes priority.
	 * @returns ServiceProxyResponse
	 */ 
	 ...
	 * @param  {number} version The version being validated. Pass -1 to bypass version checking.
	 * @returns ServiceProxyResponse
	 */ 
	 ...
	 * @param  {string} itemId The item id being deleted.
	 * @param  {number} version The version being validated. Pass -1 to bypass version checking.
	 * @param  {Object} priceJson The price details as JSON map.
	 * @returns ServiceProxyResponse
	 */ 
	 ...
	 * @param  {string} itemId The item id being deleted.
	 * @param  {number} version The version being validated. Pass -1 to bypass version checking.
	 * @param  {number} priceId The priceId being updated.
	 * @param  {Object} priceJson The price details as JSON map.
	 * @returns ServiceProxyResponse
	 */ 
	 ...
	 * @param  {number} version The version being validated. Pass -1 to bypass version checking.
	 * @param  {number} priceId The priceId being deleted.
	 * @returns ServiceProxyResponse
	 */ 
	 ...
	 * @param  {string} itemId The item id being updated.
	 * @param  {number} version The version being validated. Pass -1 to bypass version checking.
	 * @param  {number} priceId The priceId being set as the default. Pass -1 to make a product item not-for-sale.
	 * @returns ServiceProxyResponse
	 */ 
