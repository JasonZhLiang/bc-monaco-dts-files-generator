...
interface PresenceServiceProxy {
	 ...
	 * 
	 * @param  {Array<any>} profileIds Gets a list of Presence for the specified profile ids.
	 * @param  {boolean} includeOffline Should offline users be included in the response?
	 * @returns ServiceProxyResponse
	 */ 
	 ...
	 * 
	 * @param  {Object} activity Presence activity record json. Size of the given activity must be equal to or less than the *Max content size (bytes)* app setting (see Messaging > Presence in the portal).
	 * @returns ServiceProxyResponse
	 */ 
	 ...
	 * 
	 * @param  {Array<any>} profileIds An array of target profile ids.
	 * @param  {boolean} bidirectional Should those profiles be mutually registered to listen to the current profile?
	 * @returns ServiceProxyResponse
	 */ 
	 ...
	 * @param  {boolean} visible Should user appear in presence? True by default.
	 * @param  {Object} activity Presence activity record json.
	 * @param  {number} expirySecs Time before this activity record expires.
	 * @returns ServiceProxyResponse
	 */ 
	 ...
	 * 
	 * @param  {string} profileId The target profile id.
	 * @param  {number} seconds The number of seconds to extend the px expiry.
	 * @returns ServiceProxyResponse
	 */ 
