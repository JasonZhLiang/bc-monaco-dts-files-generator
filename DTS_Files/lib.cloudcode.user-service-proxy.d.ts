...
interface UserServiceProxy {
	 ...
	 * 
	 * @param  {String} profileId Profile ID of the user.
	 * @param  {NativeObject} optionsJson Additional options, including 'deleteChildren' flag to also delete children of the user. Defaults to false if not specified.
	 * @returns ServiceProxyResponse
	 */ 
