...
interface LeaderboardServiceProxy {
	 ...
	 * 
	 * @param  {NativeObject} context The context string returned from the server from a previous call to SysGetLeaderboardConfigsPage or SysGetLeaderboardConfigsPageOffset.
