...
interface AsyncMatchServiceProxy {
	 ...
	 * 
	 * @param  {Array<any>} players List of objects identifying the opponent platform and id for this match.
	 ...
	 * 
	 * @param  {Array<any>} players List of objects identifying the opponent platform and id for this match.
	 * @param  {Object} matchState JSON string blob provided by the caller.
	 * @param  {string} pushContent Optional push notification message to send to the other party. Refer to the Push Notification functions for the syntax required.
	 * @param  {string} currentPlayer Optionally, force the next player player to be a specific player.
	 * @param  {Object} summary Optional JSON string defining what the other player will see as a summary of the game when listing their games.
	 * @returns ServiceProxyResponse
	 */ 
	 ...
	 * @param  {string} ownerId The match owner id.
	 * @param  {string} matchId The match id.
	 * @param  {number} version Game state version to ensure turns are submitted once and in order.
	 * @param  {Object} matchState JSON object provided by the caller.
	 * @param  {string} pushContent Optional push notification message to send to the other party. Refer to the Push Notification functions for the syntax required.
	 * @param  {string} currentPlayer Optionally, force the next player to be a specific player.
	 * @param  {Object} summary Optional JSON object defining what the other player will see as a summary of the game when listing their games.
	 * @param  {Object} statistics Optional JSON object provided by the caller.
	 * @returns ServiceProxyResponse
	 */ 
	 ...
	 * @param  {string} matchId The match id.
	 * @param  {number} version Game state version to ensure turns are submitted once and in order.
	 * @param  {Object} summary JSON object provided by the caller that other players will see as a summary of the game when listing their games.
	 * @param  {string} pushContent Optional push notification message to send to the other party. Refer to the Push Notification functions for the syntax required.
	 * @returns ServiceProxyResponse
	 */ 
	 ...
	 * @param  {string} ownerId The match owner id.
	 * @param  {string} matchId The match id.
	 * @param  {number} version Game state version being updated, to ensure data integrity.
	 * @param  {Object} matchState JSON object provided by the caller. Overwrites the 'matchState'.
	 * @param  {Object} statistics Optional JSON object provided by the caller. Overwrites the 'statistics'.
	 * @returns ServiceProxyResponse
	 */ 
