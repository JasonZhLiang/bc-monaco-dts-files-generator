...
interface ServiceProxies {
	...
	/**
	 * Retrieves a GroupFileService proxy object.
	 * 
	 * @param session A optional parameter for when a script is executed without a session.
	 */ 
	getGroupFileServiceProxy(session?: string): GroupFileServiceProxy;
	...
	/**
	 * Retrieves a ReportService proxy object.
	 * 
	 * @param session A optional parameter for when a script is executed without a session.
	 */ 
	getReportServiceProxy(session?: string): ReportServiceProxy;

	/**
	 * Retrieves a RoomServerService proxy object.
	 * 
	 * @param session A optional parameter for when a script is executed without a session.
	 */ 
	getRoomServerServiceProxy(session?: string): RoomServerServiceProxy;
