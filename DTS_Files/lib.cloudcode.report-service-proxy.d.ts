...
interface ReportServiceProxy {
	 ...
	 * 
	 * @param  {NativeObject} optionsJson The report options to be applied. Must include 'subject'. May include 'recurrence'.
	 * @param  {Integer} maxReturn The maximum number of results to return. Typically limited to a maximum of 20 results.
	 * @returns ServiceProxyResponse
	 */ 
