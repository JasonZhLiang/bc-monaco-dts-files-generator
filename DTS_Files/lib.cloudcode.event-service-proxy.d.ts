...
interface EventServiceProxy {
	 ...
	 * @param  {Object} eventData The user-defined data for this event encoded in JSON.
	 ...
	 * 
	 * @param  {Array<any>} toIds The profile ids of the users to send the event.
	 * @param  {string} eventType The user-defined type of the event.
	 * @param  {Object} eventData The user-defined data for this event encoded in JSON.
	 * @returns ServiceProxyResponse
	 */ 
	 ...
	 * 
	 * @param  {Array<any>} evIds Collection of event ids.
	 * @returns ServiceProxyResponse
	 */ 
	 ...
	 * 
	 * @param  {number} dateMillis createdAt cut-off time whereby older events will be deleted
	 * @returns ServiceProxyResponse
	 */ 
