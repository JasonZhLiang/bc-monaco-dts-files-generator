...
interface MatchMakingServiceProxy {
	 ...
	 * @returns ServiceProxyResponse
	 */ 
	findPlayersUsingFilter(rangeDelta: long, numMatches: long, extraParms: nativeObject): ServiceProxyResponse;
	 ...
	 * @returns ServiceProxyResponse
	 */ 
	findPlayersWithAttributesUsingFilter(rangeDelta: long, numMatches: long, attributes: nativeObject, extraParms: nativeObject): ServiceProxyResponse;
