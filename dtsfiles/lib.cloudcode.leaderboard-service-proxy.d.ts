...
interface LeaderboardServiceProxy {
	 ...
	 * @returns ServiceProxyResponse
	 */ 
	getPlayersSocialLeaderboardByVersion(): ServiceProxyResponse;
	 ...
	 * @returns ServiceProxyResponse
	 */ 
	getGlobalLeaderboardPageByVersion(leaderboardId: string, sort: string, startIndex: long, endIndex: long): ServiceProxyResponse;
	 ...
	 * @returns ServiceProxyResponse
	 */ 
	getGlobalLeaderboardViewByVersion(leaderboardId: string, sort: string, beforeCount: long, afterCount: long): ServiceProxyResponse;
	 ...
	 * @returns ServiceProxyResponse
	 */ 
	getGlobalLeaderboardEntryCountByVersion(leaderboardId: string): ServiceProxyResponse;
